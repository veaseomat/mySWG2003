...
saber2h8 = {
	...
	directObjectTemplate = "object/weapon/melee/2h_sword/crafted_saber/sword_lightsaber_two_handed_s8_gen1.iff",
	craftingValues = {
		{"mindamage",395,445,0},
		{"maxdamage",505,555,0},
...
addLootItemTemplate("saber2h8", saber2h8)
