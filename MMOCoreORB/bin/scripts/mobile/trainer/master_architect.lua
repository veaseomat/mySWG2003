master_architect = Creature:new {
	--objectName = "@mob/creature_names:trainer_architect",
	randomNameType = NAME_GENERIC,
	randomNameTag = true,
  customName = "Master Archtect", 
	faction = "",
	level = 100,
	chanceHit = 0.390000,
	damageMin = 290,
	...
	lootGroups = {},
	weapons = {},
	conversationTemplate = "masterarch_template",
	attacks = {}
}
CreatureTemplates:addCreatureTemplate(master_architect,"master_architect")
