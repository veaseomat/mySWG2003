master_armorsmith = Creature:new {
	--objectName = "@mob/creature_names:trainer_armorsmith",
	randomNameType = NAME_GENERIC,
	randomNameTag = true,
  customName = "Master Armorsmith", 
	faction = "",
	level = 100,
	chanceHit = 0.390000,
	damageMin = 290,
	...
	conversationTemplate = "masterarmor_template",
	optionsBitmask = INVULNERABLE + CONVERSABLE
}
CreatureTemplates:addCreatureTemplate(master_armorsmith,"master_armorsmith")
