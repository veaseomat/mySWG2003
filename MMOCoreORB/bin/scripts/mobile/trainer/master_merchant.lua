master_merchant = Creature:new {
--	objectName = "@mob/creature_names:trainer_merchant",
	randomNameType = NAME_GENERIC,
	randomNameTag = true,
  customName = "Master Merchant", 
	faction = "",
	level = 100,
	chanceHit = 0.390000,
	damageMin = 290,
	...
	lootGroups = {},
	weapons = {},
	conversationTemplate = "mastermerchant_template",
	attacks = {}
}
CreatureTemplates:addCreatureTemplate(master_merchant,"master_merchant")
