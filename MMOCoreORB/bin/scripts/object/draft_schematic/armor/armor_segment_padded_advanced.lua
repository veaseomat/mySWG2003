...
object_draft_schematic_armor_armor_segment_padded_advanced = object_draft_schematic_armor_shared_armor_segment_padded_advanced:new {
	...
	ingredientTitleNames = {"segment_layer_assembly_plate", "armor_layer_weld_tabs", "segment_mounting_tabs", "defensive_layer", "defensive_layer_2", "defensive_layer_3"},
	ingredientSlotType = {0, 0, 0, 3, 3, 3},
	resourceTypes = {"hide_wooly_yavin4", "steel_cubirian", "steel_duralloy", "object/tangible/component/armor/shared_armor_layer.iff", "object/tangible/component/armor/shared_armor_layer.iff", "object/tangible/component/armor/shared_armor_layer.iff"},
