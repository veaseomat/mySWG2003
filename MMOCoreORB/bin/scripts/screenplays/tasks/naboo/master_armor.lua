MasterArmor = ScreenPlay:new {                
    numberOfActs = 1,                
    questString = "masterarmor_task",                   
    states = {}, 
}
registerScreenPlay("MasterArmor", true)
function MasterArmor:start()     
    -- Spawn our character into the world, setting pLarry a pointer variable we can use to check or change his state.  
    local pArmorsmith = spawnMobile("corellia", "master_armorsmith", 1, -157, 28.0, -4718, 35, 0 )
--    local pLarry = spawnMobile("naboo", "merch_crazy_larry", 1, -4881, 6.0, 4150, 35, 0 )
end
masterarmor_convo_handler = Object:new {
    tstring = "myconversation" 
}
function masterarmor_convo_handler:getNextConversationScreen(conversationTemplate, conversingPlayer, selectedOption)            
...
--                    --createLoot(pInventory, "junk", 300, false)
    ...
    function masterarmor_convo_handler:runScreenHandlers(conversationTemplate, conversingPlayer, conversingNPC, selectedOption, conversationScreen)
