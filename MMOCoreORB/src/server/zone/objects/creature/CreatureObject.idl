...
import server.zone.managers.auction.AuctionSearchTask;

@mock
@json
class CreatureObject extends TangibleObject {
	@rawTemplate(value = "ZoneClientSession*")
	@dereferenced
	...
	@weakReference
	protected transient AuctionSearchTask auctionSearch;
	...
	@dereferenced
	protected transient ReadWriteLock skillModMutex;
	...
	@dereferenced
	protected SynchronizedVectorMap<unsigned long, unsigned long> personalEnemyFlags;
	...
	public static final int CREOCOVTYPE = 2;
	...
	@local
	@read
	public final WearablesDeltaVector getWearablesDeltaVector() {
	...
	@local
	@read
	public final BuffList getBuffList() {
	...
	@preLocked
	public native void clearBankCredits(boolean notifyClient = true);

	@preLocked
	public native void clearCashCredits(boolean notifyClient = true);
	...
	@preLocked
	public native boolean subtractCredits(int credits);

	@dirty
	public native boolean verifyCashCredits(int credits);

	@dirty
	public native boolean verifyBankCredits(int credits);

	@dirty
	public native boolean verifyCredits(int credits);
	...
	public native string setFirstName(final string newFirstName);

	@read
	public native string getLastName();

	public native string setLastName(final string newLastName, boolean skipVerify);

	public native string setLastName(final string newLastName);
	...
	public boolean canTreatInjuries() {
		return !super.getPendingTask("injuryTreatment");
	}

	@dirty
	public boolean canTreatStates() {
		return !super.getPendingTask("stateTreatment");
	}

	@dirty
	public boolean canTreatWounds() {
		return !super.getPendingTask("woundTreatment");
	}

	@dirty
	public boolean canTreatConditions() {
		return !super.getPendingTask("conditionTreatment");
	}
	...
	@preLocked
	public native void setClient(ZoneClientSession cli);
	...
	public void updateKnockdownRecovery() {
		cooldownTimerMap.updateToCurrentAndAddMili("knockdownRecovery", 30000); //change recovery times here
	}
	...
	public int getBaseHAM(int idx) {
		int oldbase = baseHAM.get(idx);
		int newbase = oldbase * 2; //works but shows as buff and stat migrate breaks it
	...
	@local
	@read
	public final DeltaVector<int> getWounds() {
		return wounds;
	}
	...
	@read
	@local
	public final DeltaVector<int> getHAM() {
		return hamList;
	}

	@read
	public int getMaxHAM(int idx) {
		int oldmax = maxHamList.get(idx);
		int newmax = oldmax * 2; //
	...
	@local
	@read
	public final DeltaVector<int> getMaxHAM() {
		return maxHamList;
	}
	...
	@local
	@read
	public final DeltaVector<int> getEncumbrances() {
		return encumbrances;
	}
	...
	public float getSpeedMultiplierMod() {
		return speedMultiplierMod * 1.25;//SPEED AFFECTS RUN SPEED AND VEHICLES
	}
	...
	@local
	@read
	public final CommandQueueActionVector getCommandQueue() {
		return commandQueue;
	}
	...
	public float getRunSpeed() {
		return (runSpeed / 1.25);//divide by vehicle/run multipler, then apply a run multiplier
	}
	...
	@local
	@read
	public final DeltaVector<int> getBaseHAM() {
		return baseHAM;
	}

	@local
	@read
	public final SkillList getSkillList() {
		return skillList;
	}
	...
	@local
	@read
	public final SkillModList getSkillModList() {
		return skillModList;
	}
	...
	@local
	@dirty
	public ReadWriteLock getSkillModMutex() {
	...
	@preLocked
	public native void removeOutOfRangeObjects();

	@preLocked
	public native void synchronizeCloseObjects();

	@preLocked
	public native void addPersonalEnemyFlag(CreatureObject enemy, unsigned long duration);

	@read
	public unsigned long getPersonalEnemyFlagTime(unsigned long enemyID) {
		return personalEnemyFlags.get(enemyID);
	}

	@preLocked
	public native void removePersonalEnemyFlag(CreatureObject enemy);

	@preLocked
	public native void removePersonalEnemyFlag(unsigned long enemyID);

	@read
	public native boolean hasPersonalEnemyFlag(CreatureObject enemy);

	@preLocked
	public native void schedulePersonalEnemyFlagTasks();

	@preLocked
	public native void setHue(int hueIndex);
	...
	@weakReference
	@read
	public AuctionSearchTask getAuctionSearchTask() {
	...
	@local
	@dirty
	public void setAuctionSearchTask(AuctionSearchTask task) {
		auctionSearch = task;
	}
}
